<script>
    ...
    import "$lib/style/PrincipalPage.css";
</script>
...
<section class="welcome-container">
    ...
    <div class="hero-section">
        <h1 class="welcome-title">
            ...
            <span class="brand-learn">Learn</span><span class="brand-py"
                >.py</span
            >
        </h1>

        <p class="welcome-subtitle">
            La plataforma todo-en-uno que une a profesores y estudiantes en un
            entorno intuitivo, disponible 24/7. Simplificamos la enseñanza y el
            aprendizaje, eliminando barreras tecnológicas.
        </p>
    ...
    <div class="welcome-features">
        <div class="feature-card">
            ...
            <p class="feature-description">
                Crea y organiza tus clases, materias y horarios fácilmente.
    ...
    <div class="testimonials-section">
        ...
        <div class="testimonials">
            <div class="testimonial">
                <p>
                    "Learn.py hizo que la transición a clases en línea fuera
                    increíblemente fácil. Mis estudiantes lo aman."
                </p>
            ...
            <div class="testimonial">
                <p>
                    "Finalmente una plataforma que entiende lo que realmente
                    necesitamos en el aula."
                </p>
                <div class="testimonial-author">
                    <strong>Carlos Rodríguez</strong>
                    <span>Director de Instituto</span>
                </div>
            </div>
            <div class="testimonial">
                <p>
                    "Puedo entregar mis tareas desde el móvil y recibir feedback
                    al instante. ¡Genial!"
                </p>
                <div class="testimonial-author">
    ...
    <div class="cta-section cta-premium">
        ...
        <p class="cta-description">
            Únete a miles de profesores y estudiantes que ya confían en
            Learn.py. Comienza gratis y escala según tus necesidades.
        </p>

        <div class="pricing-highlights">
            <div class="pricing-feature">
                <i class="fas fa-check"></i> Plan Gratis: Clases ilimitadas
            </div>
            <div class="pricing-feature">
                <i class="fas fa-check"></i> Plan Premium: Soporte prioritario
            </div>
        </div>
    ...
    <div class="faq-preview">
        ...
        <div class="faq-items">
            <div class="faq-item">
                <strong>¿Necesito experiencia técnica?</strong>
                <p>
                    Para nada. Learn.py está diseñado para ser usado por
                    cualquier persona sin conocimientos técnicos.
                </p>
            </div>
            <div class="faq-item">
                <strong>¿Funciona en móviles?</strong>
                <p>
            ...
            <div class="faq-item">
                <strong>¿Hay límite de estudiantes?</strong>
                <p>
                    En el plan gratuito puedes tener hasta 30 estudiantes. Los
                    planes de pago ofrecen límites más altos.
                </p>
            </div>
        </div>
