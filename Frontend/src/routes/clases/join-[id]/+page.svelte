<script lang="ts">
    ...
    async function join() {
        ...
        */
        const respose = await fetchWithRateLimit(`${urlip}class/join/${id}/`, {
            method: "get",
            headers: {
    ...
    >
        ...
        >
            <i
                ...
                style="color: var(--success-color); font-size: 24px; margin-right: 10px;"
            ></i>
        ...
        <div style="padding: 20px;">
            <div style="margin-bottom: 20px;">
                <h3
                    style="color: var(--text-color); margin-bottom: 10px; font-size: 18px;"
                >
                    Te has unido exitosamente a la clase
                </h3>
                <p
                    style="color: var(--text-light); font-size: 16px; margin-bottom: 8px;"
                >
            ...
            <div
                style="background-color: #f0f7ff; padding: 15px; border-radius: 8px; margin-bottom: 20px;"
            >
                ...
                <p style="color: var(--text-light); font-size: 13px;">
                    <i class="fas fa-calendar-alt" style="margin-right: 8px;"
                    ></i>
                    {date}
                </p>
            </div>
...
{:else}
    <div
        class="card"
        style="max-width: 500px; margin: 40px auto; text-align: center; border: 2px solid var(--error-color);"
    >
        <div
            class="card-title"
            style="justify-content: center; margin-bottom: 8px; color: var(--error-color);"
        >
            <i
        ...
        <div style="padding: 20px;">
            <div style="margin-bottom: 20px;">
                <h3
                    style="color: var(--error-color); margin-bottom: 10px; font-size: 18px;"
                >
            ...
            >
                <p
                    style="color: var(--text-color); margin-bottom: 8px; font-size: 14px;"
                >
                    <i
                        class="fas fa-user-check"
                        style="color: var(--error-color); margin-right: 8px;"
                    ></i>
