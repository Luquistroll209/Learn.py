...
class AnnouncementSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        announcement = Announcement.objects.create(
            clase=clase, created_by=user, **validated_data
        )
        return announcement
    ...
    def get_is_teacher(self, obj):
        try:
            membership = ClaseMembership.objects.get(
                user=obj.created_by, clase=obj.clase
            )
    ...
    def get_last_activity_at(self, obj):
        ...
        last_comment_at = (
            obj.comments.order_by("-created_at")
...
class TaskSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        # clase = Clase.objects.get(id=clase_id)
        user = self.context["user"]
        return Task.objects.create(clase=clase, created_by=user, **validated_data)
